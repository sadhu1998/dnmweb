...
import 'package:dnm/models/DonorListScreenModel/GetAvailableDonorsListRequest.dart';
...
import 'package:dnm/screens_test/register/RegisterService.dart';
import 'package:dnm/screens_test/welcomeUser/DonorDetailModel.dart';
import 'package:dnm/screens_test/welcomeUser/navBarUser.dart';
import 'package:dnm/screens_test/welcomeUser/welcomeUserServices.dart';
  ...
  List<TableRow> forEachDonor(
    ...
    for (int j = startlimit; j < endlimit; j++) {
      ...
      eachRow.add(TableRow(
          decoration:
              BoxDecoration(color: _bluecolor ? Colors.blue : Colors.black12),
          children: [
